...
module "network-security-group" {
  ...
  security_rules = [
    ...
    {
      name                       = "AllowSicFw1IcaPushInbound"
      priority                   = "120"
      direction                  = "Inbound"
      access                     = "Allow"
      protocol                   = "tcp"
      ...
      description                = "Allow Check Point Internal CA Push Certificate Service"
      source_address_prefix      = "*"
      destination_address_prefix = "*"
    },
    {
      name                       = "AllowCPDInbound"
      priority                   = "130"
      direction                  = "Inbound"
      access                     = "Allow"
      protocol                   = "tcp"
      ...
      description                = "Allow Check Point control connections to CPD"
      source_address_prefix      = "*"
      destination_address_prefix = "*"
    },
    {
      name                       = "AllowCPDAmonInbound"
      priority                   = "140"
      direction                  = "Inbound"
      access                     = "Allow"
      protocol                   = "tcp"
      ...
      description                = "Allow Check Point Internal Application Monitoring"
      source_address_prefix      = "*"
      destination_address_prefix = "*"
    },
    {
      name                       = "AllowMaasTunnel"
      priority                   = "110"
      direction                  = "Outbound"
      access                     = "Allow"
      protocol                   = "tcp"
      ...
      description                = "Allow MaaS tunnel to Check Point S1C"
      source_address_prefix      = "*"
      destination_address_prefix = "*"
    },
    {
